...
const createSanityUser = async (relawanFathul_userData) => {
    ...
    const response = await fetch(`https://ln9ujpru.api.sanity.io/v2021-03-25/data/mutate/production`, {
      ...
      body: JSON.stringify({
        mutations: [
          {
            create: {
              _type: 'user-relawan-fathul', // Ganti dengan jenis dokumen pengguna di Sanity Anda
              name: relawanFathul_userData.name,
              email: relawanFathul_userData.email,
              password: relawanFathul_userData.password,
              type: relawanFathul_userData.type,
            },
          },
        ],
      }),
